#' ---
#' title: "Zajecia_08"
#' author: "Autor: Michal Zakrzewski"
#' date: "`r Sys.Date()`"
#' output:
#'   html_document:
#'     df_print: paged
...
# 1- Czy na podstawie wynik?w (otrzymanych klastr?w) mo?esz wnioskowa? o tre?ci dokument?w?

# Tak, na podstawie wynik?w klastrowania mo?na wnioskowa? o tre?ci
# dokument?w, analizuj?c najcz??ciej wyst?puj?ce s?owa w ka?dym klastrze. 
# Dokumenty przypisane do tego samego klastra charakteryzuj? si? podobnym s?ownictwem, 
# co sugeruje ich zbli?on? tematyk?. Nale?y jednak pami?ta?, ?e jest to analiza przybli?ona, 
# poniewa? model Bag of Words nie uwzgl?dnia kontekstu ani znaczenia s??w.


# 2- Jakich og?lnie obszar?w tematycznych dotycz? klastry oraz ile jest tych obszar?w?

# Liczba obszar?w tematycznych jest r?wna liczbie klastr?w.S? 4 klastry.
# Ka?dy klaster reprezentuje odr?bny temat, np. relacje mi?dzyludzkie, wydarzenia,
# edukacj? lub inne dominuj?ce motywy obecne w dokumentach.
